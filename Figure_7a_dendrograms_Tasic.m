function T_t = Figure_7a_dendrograms_Tasic(outstruct,idx,onttype,savenclose,directory)
...
R1 = rectangle('Position',[0 0 xlimits(1)+0.5 4000],'FaceColor',[areacols(4,:) 0.6],'EdgeColor','w'); hold on;
R2 = rectangle('Position',[xlimits(1)+0.5 0 xlimdiffs(2) 4000],'FaceColor',[areacols(1,:) 0.6],'EdgeColor','w'); hold on;
R3 = rectangle('Position',[xlimits(2)+0.5 0 xlimdiffs(3) 4000],'FaceColor',[areacols(3,:) 0.6],'EdgeColor','w'); hold on;
R4 = rectangle('Position',[xlimits(3)+0.5 0 xlimdiffs(4) 4000],'FaceColor',[areacols(2,:) 0.6],'EdgeColor','w'); hold on;
